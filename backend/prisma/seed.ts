...
async function main() {
  ...
  const course1 = await prisma.course.create({
    data: {
      ...
      shortDescription: 'Master the complete design lifecycle, from user research and wireframing to high-fidelity prototyping.',
      description: 'Welcome to the most comprehensive course on Product Design and UX Strategy available online. This isn\'t just another tutorial on how to use software. It\'s a deep-dive into the mindset, frameworks, and execution strategies used by the world\'s most successful tech companies.',
  ...
  const course2 = await prisma.course.create({
    data: {
      ...
      shortDescription: 'Build production-ready web applications using App Router, Server Actions, and Prisma.',
      description: 'Learn modern web development by building a complete, high-performance web platform from scratch. We cover the latest features of Next.js alongside standard industry practices.',
  ...
  const course3 = await prisma.course.create({
    data: {
      ...
      shortDescription: 'Uncover the secrets to driving millions of organic and paid impressions.',
      description: 'Master SEO, PPC, and social media algorithms in this extensive marketing bootcamp geared towards massive scale growth.',
  ...
  console.log('Seeded top courses:', course1.title, course2.title, course3.title);
}
