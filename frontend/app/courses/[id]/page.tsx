        ...
        <div className={styles.leftColumn}>
              ...
              <div className={styles.audienceItem}>
                ...
                <div>
                  ...
                  <p className={styles.audienceDesc}>
                    Looking to level up their skills in {course.category}.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={styles.certBanner}>
            <div className={styles.certInfo}>
              <span className={styles.certBadge}>
                <Trophy size={14} /> Official Credential
              </span>
              <h2 className={styles.certTitle}>Earn Your Certificate</h2>
              <p className={styles.certDesc}>
                Upon successfully completing the curriculum, you will receive a
                verifiable digital certificate. Add it to your LinkedIn profile
                or resume to demonstrate your advanced design expertise to
                future employers.
              </p>
            </div>
            <div className={styles.certVisual}>
              <Image
                src="https://images.unsplash.com/photo-1589330694653-efa648bc38fc?q=80&w=300&auto=format&fit=crop"
                width={220}
                height={150}
                alt="Certificate UI"
          ...
          <div className={styles.contentBox}>
            <div className={styles.curriculumHeader}>
              ...
              <span className={styles.curriculumStats}>
                12 sections • 145 lessons • 12h 30m total length
              </span>
            </div>
            <div className={styles.curriculumList}>
              <SectionAccordion
                ...
                lessons={[
                  ...
                  {
                    index: 4,
                    title: 'Understanding Business Goals vs User Needs',
                    duration: '12:30',
                  },
                ]}
              />
            ...
            <div className={styles.cardBody}>
              ...
              <div className={styles.guaranteeBox}>
                ...
                <p className={styles.guaranteeText}>
                  <strong>100% Satisfaction Guarantee.</strong> Not exactly what
                  you expected? Get a full refund within 30 days. No questions
                  asked.
                </p>
              </div>
            </div>
